 ...
 */
template<typename T>
inline constexpr matrix2x2<T> operator*(const matrix2x2<T> & matA, const matrix2x2<T> & matB)
{
 ...
 */
template<typename T>
inline constexpr vector2<T> operator*(const matrix2x2<T> & mat, const vector2<T> & vec)
{
 ...
 */
template<typename T>
inline constexpr vector2<T> operator*(const vector2<T> & vec, const matrix2x2<T> & mat)
{
 ...
 */
template<typename T>
inline constexpr T determinant(const matrix2x2<T> & mat)
{
 ...
 */
template<typename T>
inline constexpr matrix2x2<T> outerProduct(const vector2<T> & c, const vector2<T> & r)
{
 ...
 */
template<typename T>
inline constexpr matrix2x2<T> transpose(const matrix2x2<T> & mat)
{
 ...
 */
template<typename T>
inline constexpr matrix2x2<T> matrixCompMult(const matrix2x2<T> & matA, const matrix2x2<T> & matB)
{
