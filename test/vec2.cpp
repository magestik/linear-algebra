...
static const vec2 values_const [128];
static constexpr vec2 values_constexpr [128];

/**
 * test_vec2_static_init
 */
TEST(vec2, static_init)
{
	for (int i = 0; i < 128; ++i)
	{
...
/**
 * test_vec2_static_init_constexpr
 */
TEST(vec2, static_init_constexpr)
{
	for (int i = 0; i < 128; ++i)
	{
